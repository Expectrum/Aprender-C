...
int main(){
    ...
    if(scanf("%d", &edad) !=1){ //validamos que el contenido que se entra es un numero
        ...
        printf("\nUsted no puede entrar porque la edad minima es de 5 años y usted tiene %d años", edad);
    }

    else if(edad > 10){
        printf("\nUsted no puede entrar porque la edad maxima es de 10 años y usted tiene %d años", edad);
    }
    return 0;
}
